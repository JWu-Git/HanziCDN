...
HanziLookup.AnalyzedCharacter = function (r) {
  ...
  function u(r) {
    ...
    (t[e] = !0), t[o] && n(r[o], r[e]) < v && 0 != o && (t[o] = !1);
  ...
  function h(r, t) {
    for (var n = [], u = 0, h = 0; h != t.length; ++h) {
      ...
      if (i != u) {
        var v = o(r[u], r[i]);
        (v = Math.round((256 * v) / Math.PI / 2)), 256 == v && (v = 0);
        var f = a(r[u], r[i]);
        f = Math.round(255 * f);
        var s = e(r[u], r[i]);
  ...
  function i(r) {
    for (var t = 0; t != r.length; ++t) {
      var n = u(r[t]),
        a = h(r[t], n);
      (N += a.length), p.push(new HanziLookup.AnalyzedStroke(r[t], n, a));
    }
  }
  var v = 12.5,
    f = 1.1,
...
HanziLookup.AnalyzedStroke = function (o, i, t) {
  'use strict';
  (this.points = o), (this.pivotIndexes = i), (this.subStrokes = t);
};
var HanziLookup = HanziLookup || {};
HanziLookup.CharacterMatch = function (a, o) {
  'use strict';
  (this.character = a), (this.score = o);
};
var HanziLookup = HanziLookup || {};
HanziLookup.CubicCurve2D = function (t, n, r, u, o, e, a, i) {
  ...
  function v(t) {
    ...
    if (h > 0) {
      var s = 0 - i,
        M = s / 2 + Math.pow(h, 0.5),
        v = Math.pow(M, 0.3333333333333333),
        l = v,
        g = s / 2 - Math.pow(h, 0.5),
        k = Math.pow(0 - g, 0.3333333333333333),
        z = k,
        C = l - z - u / (3 * r);
      n.push(C);
    } else if (0 == a && 0 == i && 0 == h) n.push(-Math.pow(e / r, 1 / 3));
    else {
...
var HanziLookup = HanziLookup || {};
HanziLookup.DrawingBoard = function (e, t) {
  'use strict';
  function n() {
  ...
  function i(e, t) {
    ...
    if (!(new Date().getTime() - l < 50)) {
      ...
      var n = [e, t];
      (n[0] == f[0] && n[1] == f[1]) ||
        (T.push(n), (f = n), h.lineTo(e, t), h.stroke());
    }
  }
  function a(e, t) {
    if (!T) return;
  ...
  return (
    (r = $(
      '<canvas class="hanzi-stroke-input-canvas" id="hanzicanvas" width="256" height="256"></canvas>'
    )),
    v.append(r),
    (h = r[0].getContext('2d')),
...
var HanziLookup = HanziLookup || {};
(HanziLookup.data = {}),
  (HanziLookup.init = function (a, o, t) {
    'use strict';
    function n(a, o) {
      (HanziLookup.data[a] = JSON.parse(o)),
    ...
    e.open('GET', o, !0),
      (e.onreadystatechange = function () {
        4 === this.readyState &&
          (200 === this.status ? (n(a, e.responseText), t(!0)) : t(!1));
      }),
      e.send();
  });
var HanziLookup = HanziLookup || {};
HanziLookup.MatchCollector = function (r) {
  ...
  function n(r) {
    var n;
    for (n = 0; n < c; ++n) if (u[n].score < r) return n;
    return n;
  }
  function t(r) {
  ...
  (HanziLookup.Matcher = function (o, n) {
    ...
    function a(o, n, a) {
      ...
      for (var e = [], _ = 0; _ != o.analyzedStrokes.length; ++_)
        for (var C = o.analyzedStrokes[_], T = 0; T != C.subStrokes.length; ++T)
          e.push(C.subStrokes[T]);
      for (
        var S = o.analyzedStrokes.length,
          L = o.subStrokeCount,
          H = r(S),
          k = Math.max(S - H, 1),
          h = Math.min(S + H, HanziLookup.MAX_CHARACTER_STROKE_COUNT),
          M = t(L),
          A = Math.max(L - M, 1),
          p = Math.min(L + M, HanziLookup.MAX_CHARACTER_SUB_STROKE_COUNT),
          v = 0;
        v != O.length;
        ++v
      ) {
    ...
    function r(o) {
      ...
      var n = 0.35,
        ...
        r = 0.6,
        t = o,
        u = new HanziLookup.CubicCurve2D(
          0,
          0,
          n,
          a,
    ...
    function t(o) {
      ...
      var n = 0.25 * o,
        ...
        t = 0.75,
        u = 1.5 * r,
        i = new HanziLookup.CubicCurve2D(
          0,
          n,
          a,
          r,
    ...
    function u() {
      for (
        var o = HanziLookup.MAX_CHARACTER_SUB_STROKE_COUNT + 1, n = [], a = 0;
        a < o;
        a++
      ) {
        n.push([]);
      ...
      if (o == r[1] && o < HanziLookup.CORRECT_NUM_STROKES_CAP) {
        var u =
          (HanziLookup.CORRECT_NUM_STROKES_BONUS *
            Math.max(HanziLookup.CORRECT_NUM_STROKES_CAP - o, 0)) /
      ...
      for (var t = 0; t < n.length; t++)
        for (
          ...
          if (Math.abs(t - C) <= a) {
            ...
            E > 0 && (R = [(240 & E) >>> 4, 15 & E]);
            var H =
                p[t][C + 1] - (i / 256) * HanziLookup.SKIP_PENALTY_MULTIPLIER,
    ...
    function C() {
      var o = new HanziLookup.CubicCurve2D(0, 1, 0.5, 1, 0.25, -2, 1, 1);
      H = T(o, 256);
      var n = new HanziLookup.CubicCurve2D(0, 0, 0.25, 1, 0.75, 1, 1, 1);
      (k = T(n, 129)), (h = []);
      for (var a = 0; a <= 450; ++a) h.push(1 - Math.sqrt(a) / 22);
    }
    function T(o, n) {
      for (
        var a = o.x1(), r = o.x2(), t = r - a, u = a, i = t / n, e = [], _ = 0;
        _ < n;
        _++
      ) {
    ...
    function L(o, n) {
      var a;
      return (
        (a = o > n ? Math.round((n << 7) / o) : Math.round((o << 7) / n)), k[a]
      );
    }
    var R,
      E,
      ...
      k,
      h,
      M = n || HanziLookup.DEFAULT_LOOSENESS,
...
var hanziLookupDemoApp = (function () {
  ...
  $(document).ready(function () {
    ...
    HanziLookup.init(
      'orig',
      'https://raw.githubusercontent.com/gugray/HanziLookupJS/master/dist/orig.json',
      fileLoaded
    );
  });
  ...
  function lookup() {
    ...
    matcherOrig.match(analyzedChar, 10, function (matches) {
      showResults($('.hanzi-LookupChars'), matches);
    });
    // Look up with MMAH data
    var matcherMMAH = new HanziLookup.Matcher('mmah');
    matcherMMAH.match(analyzedChar, 10, function (matches) {
      showResults($('.hanzi-mmahLookupChars'), matches);
    });
    $('.sentinel_tracker').html("")
    $('.sentinel_tracker').html("Z")
  }
